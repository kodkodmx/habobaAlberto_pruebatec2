    ...
    <body>
        <div class="typewriter">
            ...
            <%
                ...
                if (usuario != null) {
            %>
            <h2>Por favor ingresa los datos del nuevo usuario:</h2>
        </div>
        <br>
        <form action="UsuarioSv" method="Post" autocomplete="off" id="retardo7">
            <fieldset>
                ...
                <input type="text" id="password" name="password" placeholder="Mínimo 4 caracteres" minlength="4" required autocomplete="new-password"><br><br>
                
                <label for="password2">Repite la contraseña:</label><br>
                <input type="password" id="password2" name="password2" placeholder="Repite la contraseña" minlength="4" required autocomplete="new-password"><br><br>
